...
//            openni::OpenNI::shutdown();
    ...
    */
    void getColorFrame(cv::Mat& frame)
    {
        ...
        // std::cout << "colorFrame.getDataSize() = " << colorFrame.getDataSize() << std::endl;
    ...
    */
    void getDepthFrame(cv::Mat& frame)
    {
        ...
        openni::DepthPixel* dData = (openni::DepthPixel*)m_depthFrame.getData();
        memcpy(localFrame.data, dData, m_depthFrame.getStrideInBytes() * m_depthFrame.getHeight());
